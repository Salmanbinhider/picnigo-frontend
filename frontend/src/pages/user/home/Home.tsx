...
const Home = () => {
  ...
  const { isAuthenticated, user, accessToken } = useSelector((state: RootState) => state.userAuth);
  ...
  const handleNewsletterToggle = async () => {
    ...
    try {
      ...
      toast.success(
        !isSubscribed ? 'Subscribed to newsletter successfully ' : 'Unsubscribed from newsletter.'
      );
    } catch (error) {
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-white shadow-xl rounded-3xl p-10 md:p-16 text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              ✉️ Stay in the Loop with <span className="text-orange-600">Picnigo</span>
            </h2>
            <p className="text-gray-600 mb-8">
              Get weekly travel inspiration, top-rated packages, and exclusive subscriber-only
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-500 text-sm mt-1">
                  Discover our most booked destinations every week.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-500 text-sm mt-1">
                  Be the first to know about discounts and deals.
                </p>
              </div>
                ...
                <div className="bg-orange-100 p-4 rounded-full mb-3">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M12 8c1.657 0 3 1.343 3 3S13.657 14 12 14 9 12.657 9 11s1.343-3 3-3z"
                    />
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M19.4 15A7.97 7.97 0 0112 20a7.97 7.97 0 01-7.4-5"
                    />
                  </svg>
                </div>
                <h4 className="font-semibold text-gray-700">Travel Inspiration</h4>
                <p className="text-gray-500 text-sm mt-1">
                  Explore blogs and stories that spark your wanderlust.
                </p>
              </div>
            </div>
            ...
            <button
              ...
              className={`px-8 py-3 text-lg font-semibold rounded-full transition-colors shadow-md ${
                isSubscribed
