...
const Loader: React.FC = () => (
  <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-orange-50 to-white">
    ...
    {/* Brand */}
    <h1 className="text-3xl font-semibold text-gray-800 tracking-wide">Picnigo</h1>

    {/* Loading text */}
    <p className="text-sm text-gray-500 mt-2">Preparing your journey...</p>
...
//     <h1 className="text-2xl font-bold tracking-wide animate-pulse">Picnigo</h1>
